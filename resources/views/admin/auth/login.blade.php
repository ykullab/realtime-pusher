      ...
      <div class="row align-items-center h-100">
        <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" action="{{ route('admin.login') }}" method="POST">
          ...
          <div class="form-group">
            <label for="inputEmail" class="sr-only">{{ __("keywords.Email address") }} </label>
            <input type="email" id="inputEmail" name="email" class="form-control form-control-lg" placeholder="{{ __("keywords.Email address") }}"  autofocus="">
